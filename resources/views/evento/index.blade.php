...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/js/bootstrap.bundle.min.js"></script>
 <script
                                ...
                                <div class="container">
                                    ...
                                    <div class="container theme-showcase">
                                              ...
                                              <td colspan="7">
                                                <table class="table table-striped table-condensed table-tight-vert" >
                                                  ...
                                                  <tbody>
                                                    ...
                                                    {{ } }}
                                                    <tr>
                                                      <th class="timetitle" >Después 10 PM</th>
                                      ...
                                      var data = [],
                                          ...
                                          h,
                                          m,
                                          names = [/* 'Reunión día de las madres', 'Día del padre', 'Paseo', 'Museo', 'Minga', 'Reunión escudo','Mejores promedios', 'Colada morada', 'Juramento a la bandera' */],
                                          slipsum = [""];
  ...
  {
    title: 'Olimpiadas',
    start: new Date(2023, 9, 31, ),
    end: new Date(2023, 9, 31,),
    allDay: true,
    text: 'Descripción del Evento 5'
  },
  {
    title: 'Arreglo de fachadas',
    start: new Date(2023, 5, 15, ),
    end: new Date(2023, 5, 15,),
    allDay: true,
    text: 'Descripción del Evento 6'
  },
  {
    ...
    allDay: true,
    text: 'Descripción del Evento 7'
  },
  {
    title: 'Fiesta de la lectura',
    start: new Date(2023, 7, 4, ),
    end: new Date(2023, 7, 4,),
    allDay: true,
    text: 'Descripción del Evento 8'
  },
  {
    title: 'Día del padre',
  ...
  },
  {
    ...
    allDay: true,
    text: 'Descripción del Evento 10'
  },
  {
    title: 'Día del niño',
    ...
    allDay: true,
    text: 'Descripción del Evento 11'
  },
  {
    ...
    allDay: true,
    text: 'Descripción del Evento 12'
  },
  {
    title: 'Carnaval',
    ...
    allDay: true,
    text: 'Descripción del Evento 13'
  },
  {
    ...
    allDay: true,
    text: 'Descripción del Evento 14'
  },
  {
